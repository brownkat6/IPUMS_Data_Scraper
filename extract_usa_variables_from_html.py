...
file_path = "ipums_metadata/usa_vars"
...
lines_containing_substring = [l for l in lines_containing_substring if l.split("usa-action/variables/")[1][0].isupper()]
lines_containing_substring = [l.replace("<a href=\"/usa-action/variables/","").split("\">")[0].replace("<td>","").replace("#codes_section","") for l in lines_containing_substring]
